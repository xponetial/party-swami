...
Build and refine Party Swami agent skill: marketplace-vendor-agent

Goals:
1. Improve .agents/skills/marketplace-vendor-agent/SKILL.md for production-quality clarity.
...
4. Add or update a concise build note in docs/strategy/outputs/agent-build/marketplace-vendor-agent.md describing:
   - skill contract
...
Deliverables:
- Updated .agents/skills/marketplace-vendor-agent/SKILL.md
- Build note at docs/strategy/outputs/agent-build/marketplace-vendor-agent.md

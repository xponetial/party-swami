...
Build and refine Party Swami agent skill: brain-orchestrator

Goals:
1. Improve .agents/skills/brain-orchestrator/SKILL.md for production-quality clarity.
...
4. Add or update a concise build note in docs/strategy/outputs/agent-build/brain-orchestrator.md describing:
   - skill contract
...
Deliverables:
- Updated .agents/skills/brain-orchestrator/SKILL.md
- Build note at docs/strategy/outputs/agent-build/brain-orchestrator.md

...
Build and refine Party Swami agent skill: rsvp-guest-agent

Goals:
1. Improve .agents/skills/rsvp-guest-agent/SKILL.md for production-quality clarity.
...
4. Add or update a concise build note in docs/strategy/outputs/agent-build/rsvp-guest-agent.md describing:
   - skill contract
...
Deliverables:
- Updated .agents/skills/rsvp-guest-agent/SKILL.md
- Build note at docs/strategy/outputs/agent-build/rsvp-guest-agent.md

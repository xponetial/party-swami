...
Build and refine Party Swami agent skill: vendor-onboarding-agent

Goals:
1. Improve .agents/skills/vendor-onboarding-agent/SKILL.md for production-quality clarity.
...
4. Add or update a concise build note in docs/strategy/outputs/agent-build/vendor-onboarding-agent.md describing:
   - skill contract
...
Deliverables:
- Updated .agents/skills/vendor-onboarding-agent/SKILL.md
- Build note at docs/strategy/outputs/agent-build/vendor-onboarding-agent.md

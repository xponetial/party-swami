...
Build and refine Party Swami agent skill: shopping-recommendation-agent

Goals:
1. Improve .agents/skills/shopping-recommendation-agent/SKILL.md for production-quality clarity.
...
4. Add or update a concise build note in docs/strategy/outputs/agent-build/shopping-recommendation-agent.md describing:
   - skill contract
...
Deliverables:
- Updated .agents/skills/shopping-recommendation-agent/SKILL.md
- Build note at docs/strategy/outputs/agent-build/shopping-recommendation-agent.md

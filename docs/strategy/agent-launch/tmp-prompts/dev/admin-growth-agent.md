...
Build and refine Party Swami agent skill: admin-growth-agent

Goals:
1. Improve .agents/skills/admin-growth-agent/SKILL.md for production-quality clarity.
...
4. Add or update a concise build note in docs/strategy/outputs/agent-build/admin-growth-agent.md describing:
   - skill contract
...
Deliverables:
- Updated .agents/skills/admin-growth-agent/SKILL.md
- Build note at docs/strategy/outputs/agent-build/admin-growth-agent.md

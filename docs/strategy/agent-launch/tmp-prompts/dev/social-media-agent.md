...
Build and refine Party Swami agent skill: social-media-agent

Goals:
1. Improve .agents/skills/social-media-agent/SKILL.md for production-quality clarity.
...
4. Add or update a concise build note in docs/strategy/outputs/agent-build/social-media-agent.md describing:
   - skill contract
...
Deliverables:
- Updated .agents/skills/social-media-agent/SKILL.md
- Build note at docs/strategy/outputs/agent-build/social-media-agent.md

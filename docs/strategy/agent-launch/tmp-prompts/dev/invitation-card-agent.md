...
Build and refine Party Swami agent skill: invitation-card-agent

Goals:
1. Improve .agents/skills/invitation-card-agent/SKILL.md for production-quality clarity.
...
4. Add or update a concise build note in docs/strategy/outputs/agent-build/invitation-card-agent.md describing:
   - skill contract
...
Deliverables:
- Updated .agents/skills/invitation-card-agent/SKILL.md
- Build note at docs/strategy/outputs/agent-build/invitation-card-agent.md

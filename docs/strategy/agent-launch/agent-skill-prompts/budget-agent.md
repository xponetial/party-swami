Build and refine Party Swami agent skill: budget-agent

Goals:
1. Improve .agents/skills/budget-agent/SKILL.md for production-quality clarity.
...
4. Add or update a concise build note in docs/strategy/outputs/agent-build/budget-agent.md describing:
   - skill contract
...
Deliverables:
- Updated .agents/skills/budget-agent/SKILL.md
- Build note at docs/strategy/outputs/agent-build/budget-agent.md
